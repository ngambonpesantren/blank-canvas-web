...
define(['./workbox-99d65858'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^\/(?:vaults|install|404)$/, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\.md$/i, new workbox.NetworkFirst({
